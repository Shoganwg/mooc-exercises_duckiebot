...
def get_steer_matrix_left_lane_markings(shape):
    ...
    # print("left shape =  ", shape)
    steer_matrix_left_lane = np.ones(shape) * -1 / 200 / 3
    leftc,rightc = int(cn * 1/3), int(cn * (1 - 1/3))
    steer_matrix_left_lane[:,leftc:rightc] = steer_matrix_left_lane[:,leftc:rightc] * 6
...
def get_steer_matrix_right_lane_markings(shape):
    ...
    steer_matrix_right_lane =   np.ones(shape)  * 1 / 200 / 3
    leftc,rightc = int(cn * 1/3), int(cn * (1 - 1/3))
    steer_matrix_right_lane[:,leftc:rightc] = steer_matrix_right_lane[:,leftc:rightc] * 5
